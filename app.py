...
if module == "1. Relegation Capital Risk Matrix":
    st.title(" Bundesliga Telemetry & Relegation Risk Engine")
...
# ========================================================
    ...
    st.title(" Wage Expenditure Performance Efficiency Matrix")
...
# ========================================================
    ...
    st.title(" Academy Structural Contribution Log")
...
- minutes_played_by_academy (INTEGER)
    ...
    # Preset queries to guide recruiters
    ...
    # Map presets to default text values
    ...
    if st.button("Execute Live Query ⚡"):
        try:
            ...
            # Contextual download button for data export
